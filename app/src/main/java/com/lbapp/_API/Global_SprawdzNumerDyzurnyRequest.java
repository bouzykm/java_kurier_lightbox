...
public class Global_SprawdzNumerDyzurnyRequest extends StringRequest{

    static String port = _PORT.getPort();
    private static final String URL=port+"/lkls0987sdf98sdfNLNJXJLOIlkhsd7UX098zsd98f7sd/sprawdzNumerDyzurny";
    private Map<String, String> params, headers;

    public Global_SprawdzNumerDyzurnyRequest(Context c, Response.Listener<String> listener, Response.ErrorListener errorListener){
