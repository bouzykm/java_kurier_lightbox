...
public class Koordynator_Prognoza__ListaPrognozy_Downloader extends AsyncTask<String,Void,String>{
    ...
    String trasa= _GlobalVariable.getTrasaKoor();
    TextView tvInfoPrognoza;

    public Koordynator_Prognoza__ListaPrognozy_Downloader(Context c, ListView lvListaPrognozy, TextView tvInfoPrognoza) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            if (s == null) {
                try {
                    ...
                    builder.setPositiveButton("Odśwież",
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    final Koordynator_Prognoza__ListaPrognozy_Downloader d = new Koordynator_Prognoza__ListaPrognozy_Downloader(c, lvListaPrognozy, tvInfoPrognoza);;
                                    d.execute();
                                }});
                ...
                Koordynator_Prognoza__ListaPrognozy_Parser p = new Koordynator_Prognoza__ListaPrognozy_Parser(c, s, lvListaPrognozy, tvInfoPrognoza);
                p.execute();
            }
    ...
    private String downloadData()
    {
        ...
        try {
            URL url=new URL(port+"/lkls0987sdf98sdfNLNJXJLOIlkhsd7UX098zsd98f7sd/AdresPrognoza");
...
//            final String retSymbolKoordynatora = sharedPreferencesSymbol.getString("retSymbolKoordynatora", "");
            ...
            con.setRequestProperty("symbolKoordynatora", trasa);
        } catch (IOException e) {
            e.printStackTrace();
        }
