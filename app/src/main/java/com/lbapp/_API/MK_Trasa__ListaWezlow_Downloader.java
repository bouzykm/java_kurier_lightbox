...
public class MK_Trasa__ListaWezlow_Downloader extends AsyncTask<String,Void,String>{
    ...
    public MK_Trasa__ListaWezlow_Downloader(Context c, ListView lvListaMK) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            if (s == null) {
                try {
                    ...
                    builder.setPositiveButton("Odśwież",
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    final MK_Trasa__ListaWezlow_Downloader d = new MK_Trasa__ListaWezlow_Downloader(c, lvListaMK);
                                    d.execute();
                                }});
                ...
                MK_Trasa__ListaWezlow_Parser p = new MK_Trasa__ListaWezlow_Parser(c, s, lvListaMK);
                p.execute();
            }
    ...
    private String downloadData()
    {
        ...
        try {
            URL url=new URL(port+"/lkls0987sdf98sdfNLNJXJLOIlkhsd7UX098zsd98f7sd/AdresMK");
