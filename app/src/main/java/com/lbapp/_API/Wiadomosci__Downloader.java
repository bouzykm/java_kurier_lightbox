...
public class Wiadomosci__Downloader extends AsyncTask<String,Void,String>{
    ...
    public Wiadomosci__Downloader(Context c, ListView lvWiadomosci) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            if (s == null) {
                try {
                    ...
                    builder.setPositiveButton("Odśwież",
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    final Wiadomosci__Downloader d = new Wiadomosci__Downloader(c, lvWiadomosci);
                                    d.execute();
                                }});
                ...
                Wiadomosci__Parser p = new Wiadomosci__Parser(c, s, lvWiadomosci);
                p.execute();
            }
    ...
    private String downloadData()
    {
        ...
        try {
            URL url=new URL(port+"/lkls0987sdf98sdfNLNJXJLOIlkhsd7UX098zsd98f7sd/sprawdzWiadomosci");
            ...
            rola = sharedPreferencesRetRole.getInt("retRole", 0);
...
//            final String retSymbolKoordynatora = sharedPreferencesSymbol.getString("retSymbolKoordynatora", "");
            ...
            con.setRequestProperty("rola", String.valueOf(rola));
        } catch (IOException e) {
            e.printStackTrace();
        }
