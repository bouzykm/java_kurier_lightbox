...
public class MK_Trasa__ListaTrasKurierskich_Downloader extends AsyncTask<String,Void,String>{
    ...
    int trasaId= _GlobalVariable.getTrasaIdMK();

    public MK_Trasa__ListaTrasKurierskich_Downloader(Context c, ListView lvListaMKTras) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            if (s == null) {
                try {
                    ...
                    builder.setPositiveButton("Odśwież",
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    final MK_Trasa__ListaTrasKurierskich_Downloader d = new MK_Trasa__ListaTrasKurierskich_Downloader(c, lvListaMKTras);
                                    d.execute();
                                }});
                ...
                MK_Trasa__ListaTrasKurierskich_Parser p = new MK_Trasa__ListaTrasKurierskich_Parser(c, s, lvListaMKTras);
                p.execute();
            }
    ...
    private String downloadData()
    {
        ...
        try {
            URL url=new URL(port+"/lkls0987sdf98sdfNLNJXJLOIlkhsd7UX098zsd98f7sd/AdresMKTrasaKurierska");
...
//            final String retSymbolKoordynatora = sharedPreferencesSymbol.getString("retSymbolKoordynatora", "");
            ...
            con.setRequestProperty("trasaId", String.valueOf(trasaId));
        } catch (IOException e) {
            e.printStackTrace();
        }
