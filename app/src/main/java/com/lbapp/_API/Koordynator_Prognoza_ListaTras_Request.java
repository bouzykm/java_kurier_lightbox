...
public class Koordynator_Prognoza_ListaTras_Request extends StringRequest{

    static String port = _PORT.getPort();
    private static final String URL=port+"/lkls0987sdf98sdfNLNJXJLOIlkhsd7UX098zsd98f7sd/TrasaPrognoza";
    private Map<String, String> params, headers;
    String dataDostawy= _GlobalVariable.getDateFormat();

    public Koordynator_Prognoza_ListaTras_Request(Context c, Response.Listener<String> listener, Response.ErrorListener errorListener){
