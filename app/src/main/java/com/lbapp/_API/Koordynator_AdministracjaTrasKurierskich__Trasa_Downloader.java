...
public class Koordynator_AdministracjaTrasKurierskich__Trasa_Downloader extends AsyncTask<String,Void,String>{
    ...
    public Koordynator_AdministracjaTrasKurierskich__Trasa_Downloader(Context c, ListView lvLista, TextView tvInfo) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            if (s == null) {
                try {
                    ...
                    builder.setPositiveButton("Odśwież",
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    final Koordynator_AdministracjaTrasKurierskich__Trasa_Downloader d = new Koordynator_AdministracjaTrasKurierskich__Trasa_Downloader(c, lvLista, tvInfo);
                                    d.execute();
                                }});
                ...
                Koordynator_AdministracjaTrasKurierskich__Trasa_Parser p = new Koordynator_AdministracjaTrasKurierskich__Trasa_Parser(c, s, lvLista, tvInfo);
                p.execute();
            }
    ...
    private String downloadData()
    {
        ...
        try {
            URL url=new URL(port+"/lkls0987sdf98sdfNLNJXJLOIlkhsd7UX098zsd98f7sd/KoordynatorAdministracjaTrasa");
