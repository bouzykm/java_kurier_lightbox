...
public class Koordynator_AdministracjaTrasKurierskich_ListaTrasRequest extends StringRequest{

    static String port = _PORT.getPort();
    private static final String URL=port+"/lkls0987sdf98sdfNLNJXJLOIlkhsd7UX098zsd98f7sd/KoordynatorAdministracjaListaTras";
    private Map<String, String> params, headers;
    String dataDostawy= _GlobalVariable.getDateFormat();

    public Koordynator_AdministracjaTrasKurierskich_ListaTrasRequest(Context c, Response.Listener<String> listener, Response.ErrorListener errorListener){
