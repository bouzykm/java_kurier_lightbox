...
public class MK_Grafik__Lista_Downloader extends AsyncTask<String,Void,String>{
    ...
    public MK_Grafik__Lista_Downloader(Context c, ListView lvMkGrafik) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            if (s == null) {
                try {
                    ...
                    builder.setPositiveButton("Odśwież",
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    final MK_Grafik__Lista_Downloader d = new MK_Grafik__Lista_Downloader(c, lvMkGrafik);
                                    d.execute();
                                }});
                ...
                MK_Grafik__Lista_Parser p = new MK_Grafik__Lista_Parser(c, s, lvMkGrafik);
                p.execute();
            }
    ...
    private String downloadData()
    {
        ...
        try {
            URL url=new URL(port+"/lkls0987sdf98sdfNLNJXJLOIlkhsd7UX098zsd98f7sd/MkGrafikLista");
