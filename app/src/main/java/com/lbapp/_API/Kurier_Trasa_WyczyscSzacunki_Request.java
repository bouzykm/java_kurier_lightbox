...
public class Kurier_Trasa_WyczyscSzacunki_Request extends StringRequest{

    static String port = _PORT.getPort();
    private static final String URL=port+"/lkls0987sdf98sdfNLNJXJLOIlkhsd7UX098zsd98f7sd/wyczyscSzacunki";
    private Map<String, String> params, headers;
    String dataDostawy= _GlobalVariable.getDateFormat();

    public Kurier_Trasa_WyczyscSzacunki_Request(Context c, String trasa, Response.Listener<String> listener, Response.ErrorListener errorListener){
